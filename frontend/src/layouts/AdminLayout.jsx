...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'डिजिटल पावत्या (Receipts)', path: '/admin/receipts', icon: '🧾', roles: ['super_admin', 'treasurer', 'receipt_manager', 'event_manager', 'volunteer'] },
    { name: 'सभासद / देणगीदार (Members)', path: '/admin/members', icon: '👥', roles: ['super_admin', 'treasurer', 'receipt_manager', 'event_manager', 'volunteer'] },
    { name: 'जमा नोंदी (Income)', path: '/admin/income', icon: '💰', roles: ['super_admin', 'treasurer', 'receipt_manager', 'event_manager', 'volunteer'] },
    { name: 'खर्च व्यवस्थापन (Expenses)', path: '/admin/expenses', icon: '💸', roles: ['super_admin', 'treasurer', 'receipt_manager', 'event_manager', 'volunteer'] },
